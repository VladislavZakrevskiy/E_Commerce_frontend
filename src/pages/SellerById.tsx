...
import SellerStat from '../entites/Seller/SellerStat';
...
const SellerById = () => {
	...
	const seller: ISeller = {
		...
		city: 'Znamensk',
		house_number: 14,
		house_street: 'Chernychovskogo',
		country: 'Russia',
		email: 'zakrevskiyvlada@yandex.ru',
		firstName: 'Vlad',
		lastName: 'Zakrevskiy',
		photo: '../../public/avatar.jpg',
		preferences: ['Beauty', 'Entertainment', 'For Home', 'No Tag', 'Technic'],
		rating: 3,
		settings: {
			isFriend: false,
			menuSide: 'left',
	...
	return (
		<Container>
			<UserActionTab
				canCall={seller.settings.permissions.canCall}
				canMessage={seller.settings.permissions.canMessage}
				id={id!}
				isFriend={seller.settings.isFriend}
			/>
			<UserDescription user={seller} />
			<SellerStat
				amount_customers={seller.amount_customer}
